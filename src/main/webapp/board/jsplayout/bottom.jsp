	...
	<footer id="ateam_footer" class="ateam_footer wf-section">
		<div class="w-container">
			<div class="footer-flex-container">
				...
				<div>
					<h2 class="ateam_footer_heading">Powered By</h2>
					<ul role="list" class="w-list-unstyled">
						<li><a href="https://webflow.com/" class="ateam_footer-link">Webflow</a></li>
						<li><a href="https://getbootstrap.com/" class="ateam_footer-link">Bootstrap</a></li>
					</ul>
				</div>
				<div>
