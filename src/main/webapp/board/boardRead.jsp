...
<body class="page">
	...
	<div class="layout-top w-container">
		...
		<div><img src="icon/profile_def.png" width="20vw"> <%=bBean.getId() %> | <%=bBean.getRegdate() %> | <%=bBean.getCount() %> | ´ñ±Û 0</div>
	</div>
	...
	<div class="layout-lower-bottom w-container">
		<button id="replybtn" type="button" class="btn btn-dark">´ä±Û</button>
		<button id="listbtn" type="button" class="btn btn-dark">¸ñ·Ï</button>
	</div>
	...
	<form name="commentFrm" action="commentPost" method="post">
		...
		<div class="comment-write-container w-container">
			<div class="input-group mb-3">
				...
				<input class="btn btn-outline-secondary" type="submit" id="button-addon2" value="µî·Ï">
