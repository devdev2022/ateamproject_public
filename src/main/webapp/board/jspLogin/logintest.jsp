...
<body class="body">
	<div class="form-block-6 w-form">
		<form id="email-form" name="email-form" data-name="Email Form"
			method="get" class="form-6">
			<input type="text" class="text-field-8 w-input" maxlength="256"
				name="name" data-name="Name" placeholder="아이디" id="name" /><input
				type="email" class="text-field-7 w-input" maxlength="256"
				name="email" data-name="Email" placeholder="비밀번호" id="email"
				required="" /><a href="#" class="link-6">회원가입</a><a href="#"
				class="link-7">ID/PW 찾기</a><a href="#" class="button-5 w-button"><br />로그인</a>
		</form>
