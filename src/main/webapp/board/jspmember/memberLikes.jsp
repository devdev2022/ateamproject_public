...
<%
	...
	Vector<LikesBean> lCVlist = lMgr.getAllNumLikes(loginId);
	totalRecord = lCVlist.size();
...
<div class="panel" style="display:flex; flex-direction: column; margin-top: 5vw; margin-bottom: 5vw;  margin-left: 3vw; margin-right: 3vw; ">
	...
	<div><h3>내가 좋아하는 게시글 <img src="icon/save_post_before.png"></h3> <hr> 총 <%=lVlist.size() %>개의 게시물</div>
