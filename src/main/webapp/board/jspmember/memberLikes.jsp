...
<div class="panel" style="display:flex; flex-direction: column; margin-top: 5vw; margin-left: 3vw; margin-right: 3vw; ">

	<div><h3>내가 좋아한 게시글</h3></div>
	
	<div class="w-layout-grid grid_main">
		<div id="w-node-d1c3c07c-8ff6-dd72-39b2-8cb50c75383f-69768b56" class="grid_item">
