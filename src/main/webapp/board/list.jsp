...
<h2>JSP Board</h2><br/>
		<div class="row">
			...
			<div class="alert alert-info" role="alert">파일 사이즈가 적합하지 않습니다!</div>
		</div>
			

		<div><span class="">HipHople 자유게시판</span>
...
<table>
	...
	<tr>
		...
		<td align="right">
			<a style="color:white;" href="post.jsp"><button type="button" class="btn btn-dark">글쓰기</button></a>
			<a href="post.jsp"><button type="button" class="btn btn-light">처음으로</button></a>
		</td>
	</tr>
</table>
<!-- 게시물 리스트 End -->
