...
.link-block-2 {
  width: 728px;
  height: 170px;
  background-image: url("https://uploads-ssl.webflow.com/6279d2a8b52679164d96aae3/6279dade0739521177652c31_%EB%B0%B0%EB%84%88.png");
  background-position: 0px 0px;
  background-size: cover;
...
.link-block-11 {
  ...
  width: 20px;
  height: 20px;
  background-image: url("https://uploads-ssl.webflow.com/6279d2a8b52679164d96aae3/627a5c09c5b9ff7cab6b771e_pngwing.com.png");
  background-position: 0px 0px;
  background-size: cover;
}
...
#w-node-b052e812-24e7-8858-cef8-bd1f2dfc6522-ec96aae4 {
...
<div class="frame_block">
	...
	<div class="board_block">
		...
		<div class="w-layout-grid board_grid">
			...
			<div>
				<a href="#" class="link-block w-inline-block" style="background-img: url('photo/homeTest3.jpg');"><div
						class="trans_block">
						<div>
							<div class="text-block-6">
								게시글 제목<br />작성자명 / 게시판 구분 / 게시판 내 카테고리 구분
			...
			<div>
				<a href="#" class="link-block w-inline-block"><div class="trans_block">
						<div>
							<div class="text-block-6">
								게시글 제목<br />작성자명 / 게시판 구분 / 게시판 내 카테고리 구분
							</div>
