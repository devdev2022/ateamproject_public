...
.w-file-upload-default.w-hidden, .w-file-upload-uploading.w-hidden,
	.w-file-upload-error.w-hidden, .w-file-upload-success.w-hidden {
	display: none
}
...
.link-block-2 {
	...
	height: 170px;
	background-image:
		url("https://uploads-ssl.webflow.com/6279d2a8b52679164d96aae3/6279dade0739521177652c31_%EB%B0%B0%EB%84%88.png");
	background-position: 0px 0px;
	background-size: cover;
...
.link-block-3 {
	...
	padding-top: 135px;
	background-image:
		url("https://uploads-ssl.webflow.com/6279d2a8b52679164d96aae3/627a04f077060c2175639052_2.png");
	background-position: 0px 0px;
...
.link-block-4 {
	width: 200px;
	background-image:
		url("https://uploads-ssl.webflow.com/6279d2a8b52679164d96aae3/627a050b1591452df0099b12_3.png");
}
...
.link-block-5 {
	...
	padding-top: 135px;
	background-image:
		url("https://uploads-ssl.webflow.com/6279d2a8b52679164d96aae3/6279d970ae44fa0e0e1511ac_01.png");
	background-position: 0px 0px;
	background-size: cover;
	text-decoration: none;
}
...
.link-block-11 {
	...
	height: 20px;
	background-image:
		url("https://uploads-ssl.webflow.com/6279d2a8b52679164d96aae3/627a5c09c5b9ff7cab6b771e_pngwing.com.png");
	background-position: 0px 0px;
	background-size: cover;
}
	...
	<div class="board_block">
		...
		<div class="w-layout-grid board_grid">
			<div class="grid-container">
				<a href="#" class="link-block w-inline-block" style="background-image: url('../photo/homeTest1.png');">
			...
			<div>
				<a href="#" class="link-block w-inline-block" style="background-image: url('../photo/homeTest2.jpg');">
					<div class="trans_block">
						<div>
							<div class="text-label">
								게시글 제목<br/>작성자명 / 게시판 구분 / 카테고리 구분<br>♡ 1  |  조회수 13
