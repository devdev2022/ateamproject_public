...
@media screen and (max-width: 991px) {
  .grid {
    margin: 1%;
    padding-top: 0%;
    -ms-grid-columns: minmax(100px, 1fr) 1fr 1fr;
...
<body class="body">
	...
	<div class="columns w-row">
		<div
			class="column c1 w-col w-col-4 w-col-medium-4 w-col-small-small-stack">
			<div class="div-block"></div>
			<div class="text-block-5">회원정보 수정</div>
		</div>
		<div
			class="column c2 w-col w-col-4 w-col-medium-4 w-col-small-small-stack">
			<div class="div-block-2"></div>
			<div class="text-block-3">내가 좋아한 게시물</div>
		</div>
		<div
			class="column c3 w-col w-col-4 w-col-medium-4 w-col-small-small-stack">
