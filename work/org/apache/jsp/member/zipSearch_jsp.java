 ...
 * Generated at: 2022-04-18 00:32:55 UTC
...
public final class zipSearch_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if(search.equals("y")){
      ...
      out.write("		f = document.zipFrm;\r\n");
      out.write("		if(f.area3.value==\"\"){\r\n");
      out.write("			<!--공백이 문제가 되었다는 얘기를 한 것 같은데? 자바스크립트는 이게 문제라고...-->\r\n");
      out.write("			alert(\"도로명을 입력하세요.\");\r\n");
      out.write("			f.area3.focus();\r\n");
      out.write("			return;\r\n");
      out.write("		}\r\n");
      out.write("		f.action = \"zipSearch.jsp\";\r\n");
      out.write("		f.submit();\r\n");
      out.write("	}\r\n");
      out.write("	\r\n");
      out.write("	function sendAdd(zipcode, adds){\r\n");
      out.write("		//opener는 지금 창으로 연결해준 이전 창을 가리킨다. 자바 할때 이런거 하고 싶었지?!\r\n");
      ...
      out.write("		<!-- action을 생략하면 재귀호출(자기 페이지 호출). -> 검색, 게시판 등. -->\r\n");
      out.write("		<form name=\"zipFrm\" method=\"post\">\r\n");
      out.write("			<table>\r\n");
      out.write("				<tr>\r\n");
      out.write("					<td>\r\n");
      out.write("					<br>도로명 입력 : 	<input name=\"area3\" value=\"인수봉로\">\r\n");
      ...
      out.write("				");
				...
				//search값이 n일 때는 창만 open, y일 때 검색.
					if(search.equals("y")){
						if(vlist.isEmpty()){
				
      out.write("\r\n");
      out.write("				<tr>\r\n");
      out.write("					<td align=\"center\"><br>검색 결과가 없습니다.</td> \r\n");
      out.write("				</tr>\r\n");
      out.write("				");
}else{
      out.write("\r\n");
      ...
      out.write("				<tr>\r\n");
      out.write("					<td>\r\n");
      out.write("					<a href=\"#\" onclick=\"sendAdd('");
      out.print(zipcode);
      out.write('\'');
      out.write(',');
      out.write('\'');
