 ...
 * Generated at: 2022-04-23 14:03:15 UTC
...
public final class showGuestBook_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/guestbook/postGuestBook.jsp", Long.valueOf(1650331193693L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("		window.open(url, \"GuestBook Update\", \r\n");
      out.write("				\"width=520,height=300\");\r\n");
      out.write("	}\r\n");
      out.write("	\r\n");
      out.write("	function commentFn(frm){//commentthis.form\r\n");
      ...
      out.write("			</tr>\r\n");
      out.write("		</table>\r\n");
      out.write("		<form name=\"postFrm\" method=\"get\" action=\"postGuestBookProc.jsp\">\r\n");
      ...
      out.write("	    <!-- login변수는 postGuestBook.jsp에 선언됨. -->\r\n");
      out.write("		<td><b>");
      out.print(login.getName());
      out.write("</b></td>\r\n");
      out.write("		<td align=\"right\"><b><a href=\"logout.jsp\">로그아웃</a></b></td>\r\n");
      out.write("	</tr>\r\n");
      out.write("</table>\r\n");
...
if(writer.getHp()==null||writer.getHp().equals("")){ 
      ...
      out.write("					");
							...
							//수정,삭제 : 로그인 id, 글쓴이 id 동일, 삭제 : 관리자
							//방명록 글쓴이와 로그인 id가 동일여부값
...
if(bean.getSecret().equals("1")){
      ...
      out.write("<!-- div에 id값을 \"동적\"으로 부여한다! -->\r\n");
      out.write("<div id=\"cmt");
      out.print(bean.getNum());
      out.write("\" style=\"display: none\">\r\n");
      out.write("<!-- display: none이니까 처음에는 보이지 않는다. -->\r\n");
	...
	if(!cvlist.isEmpty()){
      ...
      out.write("	");
		...
		for(int j=0; j<cvlist.size(); j++){
			//i는 안 된다. 상단에서 방명록 관련해서 이미 i를 썼다.
      ...
      out.write("								<!-- 삭제는 로그인 아이디와 댓글 아이디가 동일한 경우. -->\r\n");
      out.write("								");
if(login.getId().equals(cbean.getCid())) 
      out.write("\r\n");
      out.write("									<a href=\"commentProc.jsp?\r\n");
      out.write("									flag=delete&cnum=");
      ...
      out.write("		</td>\r\n");
      out.write("		<td>\r\n");
      out.write("			<!-- 지금까지 수정, 삭제, ... 페이지를 따로 만들었는데, 하나의 페이지로 만드는 방법도 있어요. -->\r\n");
      out.write("			<!-- 쇼핑몰이 그렇게 하고, 게시판은 기능이 많아서 그렇게 안 해요.\r\n");
      out.write("			<!-- 한 페이지에 넣는 방법이 장점만 있는 것도 아닙니다. -->\r\n");
      out.write("			<input type=\"button\" value=\"댓글\" onclick=\"commentFn(this.form)\">\r\n");
      out.write("			<!-- 클릭하면 지금 이 폼의 내용을 받아서 commentFn 실행. -->\r\n");
